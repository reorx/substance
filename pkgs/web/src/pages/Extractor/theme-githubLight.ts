...
const githubLightInit = (options?: Partial<CreateThemeOptions>) => {
  ...
  return createTheme({
    ...
    styles: [
      ...
      { tag: [t.name, t.quote], color: '#373737' },
      { tag: [t.heading], fontWeight: 'bold' },
      { tag: [t.emphasis], fontStyle: 'italic' },
      { tag: [t.deleted], color: '#b31d28', backgroundColor: 'ffeef0' },
      { tag: [t.atom, t.bool, t.special(t.variableName)], color: '#e36209' },
      { tag: [t.url, t.escape, t.regexp, t.link], color: '#032f62' },
      { tag: t.link, textDecoration: 'none', color: '#194e92' },
      { tag: t.strikethrough, textDecoration: 'line-through' },
      { tag: t.invalid, color: '#cb2431' },
      ...styles,
    ],
    customThemeOptions: (themeOptions) => {
      themeOptions['.cm-blockquote'] = {
...
const githubDarkInit = (options?: Partial<CreateThemeOptions>) => {
